...
- **[Dissertation]({{ "/portfolio/#ai-agentic-game-design" | relative_url }})** — *Agentic by Design: A Needs-Driven GenAI System Design Study for Game-Based Language Education in Higher Education.* Doctoral dissertation (in progress), University of Central Florida.
...
My work also examines how people engage with AI beyond the classroom — from affective responses to generative NPCs, to critical AI literacy pedagogy, to the politics of trust, bias, and cultural representation in AI systems.
...
- **Agentic AI System design** — see the **[Dissertation]({{ "/portfolio/#ai-agentic-game-design" | relative_url }})** project.
...
- Hall, A. &amp; Kong, Y. (2025). [Race, Technology, and Trust: Examining the Cheating Discourse Among Black and Asian AI Users](https://doi.org/10.1109/ProComm64814.2025.00052). *IEEE ProComm 2025.*
...
A [Twine hypertext project](https://kathrynkong.github.io/Critical-Making-Portfolio/Timeline.html) exploring how game localization practices have been evolving influenced by the interplay of video games, computing technologies, translation studies and fan communities.
