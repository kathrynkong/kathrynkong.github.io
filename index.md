...
<div class="card-grid">
  ...
  <a class="card card--research" href="/portfolio/#game-based-learning-ux-research">
    <div class="card-image placeholder">
      <span class="ph-icon">🖼️</span>
      <span class="ph-caption">Image coming soon: ELLE screenshot</span>
    </div>
    <span class="card-tag card-tag--research">Research</span>
  ...
  <a class="card card--narrative" href="/portfolio/#interactive-game-localization">
    <div class="card-image placeholder">
      <span class="ph-icon">🖼️</span>
